...
var gmaterial01 = new THREE.MeshLambertMaterial({
    color:0xCFA427, side: THREE.DoubleSide
});
...
var gmaterial02 = new THREE.MeshLambertMaterial({
    color:0xC74D10, side: THREE.DoubleSide
});
...
var gmaterial03 = new THREE.MeshLambertMaterial({
    color:0x690000, side: THREE.DoubleSide
});
...
var gmaterial04 = new THREE.MeshLambertMaterial({
    color:0x4E0152, side: THREE.DoubleSide
});
...
var gmaterial05 = new THREE.MeshLambertMaterial({
    color:0x594836, side: THREE.DoubleSide
});
...
ESC06.add(gmesh1,gmesh02,gmesh03,gmesh05,gmesh06,gmesh07,gmesh08,gmesh09,gmesh10);
