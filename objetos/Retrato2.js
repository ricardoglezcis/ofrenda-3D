...
export default function gretrato2({x, y, z}){


var ggeometry01 = new THREE.BoxGeometry( 20,0.5,20 );
var texture1 = new THREE.TextureLoader().load("./assets/juan.jpg");
...
var gmaterial02 = new THREE.MeshLambertMaterial({
  color:0xFF860D, side: THREE.DoubleSide
});
...
const retrato2 = new THREE.Group();
retrato2.add(gmesh01,gmesh02,decoracion,decoracion2,gmesh05,gmesh06,gmesh07,
    gmesh08,gmesh09,gmesh10,gmesh11,gmesh12,gmesh13);
retrato2.position.set(x,y,z);
