...
export default function farolgrande({x,y,z}){
...
var mesh01 = new THREE.Mesh(geometry01,material01);
 //scene.add(mesh01);
mesh01.position.set(-43,0,0);
mesh01.castShadow = true;

var mesh03 = new THREE.Mesh(geometry01,material01);
 //scene.add(mesh03);
mesh03.position.set(133,0,0);
mesh03.castShadow = true;

//
var geometry02 = new THREE.TorusGeometry(100,0.3,8,16,2.1);
...
var mesh08 = new THREE.Mesh(geometry08,material08);
 //scene.add(mesh08);
mesh08.position.set(65,6,0);
mesh08.rotation.set(0,0,0);
mesh08.castShadow = true;

var geometry09 = new THREE.CapsuleGeometry(1,1,4,8); 
...
var mesh09 = new THREE.Mesh(geometry09,material09);
 //scene.add(mesh09);
mesh09.position.set(115,32,0);
mesh09.rotation.set(0,0,0);
mesh09.castShadow = true;

var geometry010 = new THREE.CapsuleGeometry(1,1,4,8); 
var material010 = new THREE.MeshLambertMaterial({
color: 0xE382FF, side: THREE.DoubleSide

});
var mesh010 = new THREE.Mesh(geometry010,material010);
 //scene.add(mesh010);
mesh010.position.set(-25,32,0);
mesh010.rotation.set(0,0,0);
mesh010.castShadow = true;

const FAROLGRANDE = new THREE.Group();
FAROLGRANDE.add(mesh01,mesh02,mesh03,mesh04,mesh05,mesh06,mesh07,mesh08,mesh09,mesh010); 

FAROLGRANDE.position.set(x,y,z);
